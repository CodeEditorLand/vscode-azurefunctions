...
} from "./getScriptResourcesLanguage";
...
export class ScriptTemplateProvider extends TemplateProviderBase {
	...
	public async getLatestTemplates(
		...
		const templateRelease: cliFeedUtils.IRelease =
			await cliFeedUtils.getRelease(context, latestTemplateVersion);

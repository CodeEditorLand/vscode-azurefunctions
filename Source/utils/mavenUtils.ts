...
export namespace mavenUtils {
	...
	export async function validateMavenInstalled(
		...
		try {
			...
			const message: string = localize(
				"mvnNotFound",
				'Failed to find "maven", please ensure that the maven bin directory is in your system path.',
			);
	...
	export async function getFunctionAppNameInPom(
		pomLocation: string,
	...
	export async function executeMvnCommand(
	...
	export function formatMavenArg(
		key: string,

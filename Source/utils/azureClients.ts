...
export async function createEventHubClient(
	context: AzExtClientContext,
): Promise<EventHubManagementClient> {
	return createAzureClient(
		context,
		(await import("@azure/arm-eventhub")).EventHubManagementClient,
	);
}

export async function createServiceBusClient(
	context: AzExtClientContext,
): Promise<ServiceBusManagementClient> {
	return createAzureClient(
		context,
		(await import("@azure/arm-servicebus")).ServiceBusManagementClient,
	);
}

export async function createSqlClient(
	context: AzExtClientContext,
): Promise<SqlManagementClient> {
	return createAzureClient(
		context,
		(await import("@azure/arm-sql")).SqlManagementClient,
	);
}

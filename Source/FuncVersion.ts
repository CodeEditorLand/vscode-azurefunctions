...
export async function promptForFuncVersion(
	...
	const learnMoreQp = {
		label: localize(
			"learnMore",
			"$(link-external) Learn about Azure Functions versioning...",
		),
		description: "",
		data: undefined,
	};
...
export function tryParseFuncVersion(

...
class ParsedHostJsonV2 implements IParsedHostJson {
	...
	public get routePrefix(): string {
		...
		if (
			...
			this.data.extensions.http &&
			this.data.extensions.http.routePrefix !== undefined
		) {
...
export function parseHostJson(
	data: unknown,
	version: FuncVersion | undefined,
): IParsedHostJson {
	return version === FuncVersion.v1
		? new ParsedHostJsonV1(data)
		: new ParsedHostJsonV2(data);
}

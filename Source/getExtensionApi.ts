 ...
 */
export async function getAzureContainerAppsApi(
	...
	if (acaExtension) {
		return acaExtension.getApi<acaApi.AzureContainerAppsExtensionApi>(
			"^0.0.1",
		);
	}
	...
	await context.ui.showWarningMessage(
		installMessage ??
			localize(
				"acaInstall",
				'You must have the "Azure Container Apps" extension installed to perform this operation.',
			),
		{ title: "Install", stepName: "installContainerApps" },
	);

...
export async function getLocalFuncCoreToolsVersion(
...
export function addLocalFuncTelemetry(
	context: IActionContext,
	workspacePath: string | undefined,
): void {
	context.telemetry.properties.funcCliVersion = "unknown";

	getLocalFuncCoreToolsVersion(context, workspacePath)
		.then((version: string) => {

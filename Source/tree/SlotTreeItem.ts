...
export function isSlotTreeItem(
	treeItem: SlotTreeItem | RemoteFunctionTreeItem | AzExtParentTreeItem
): treeItem is SlotTreeItem {
	return !!(treeItem as SlotTreeItem).site;
}

export class SlotTreeItem
	...
	implements IProjectTreeItem
{
	...
	public async loadMoreChildrenImpl(
		...
		return (await this.resolved.loadMoreChildrenImpl.call(
			this,
			_clearCache,
			context
		)) as AzExtTreeItem[];

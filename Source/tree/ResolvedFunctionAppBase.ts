...
import type { ApplicationSettings, FuncHostRequest } from "./IProjectTreeItem";
import type { ContainerSite } from "./containerizedFunctionApp/ResolvedContainerizedFunctionAppResource";

export abstract class ResolvedFunctionAppBase
	implements ResolvedAppResourceBase
{
	...
	public abstract getApplicationSettings(
		context: IActionContext,
	): Promise<ApplicationSettings>;

	public abstract setApplicationSetting(
		context: IActionContext,
		key: string,
		value: string,
	): Promise<void>;
	...
	public abstract pickTreeItemImpl(

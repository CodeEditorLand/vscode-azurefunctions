...
export class LocalProjectTreeItem
	extends LocalProjectTreeItemBase
	implements Disposable, IProjectTreeItem
{
	public static contextValue = "azFuncLocalProject";
	...
	public constructor(
		...
		localProject: LocalProjectInternal,
	) {
		...
		this._disposables.push(
			createRefreshFileWatcher(
				this,
				path.join(this.effectiveProjectPath, localSettingsFileName),
			),
		);
	...
	private async onFuncTaskChanged(

...
export class LocalFunctionTreeItem extends FunctionTreeItemBase {
	...
	private constructor(
		...
		localFunction: ILocalFunction
	) {
		super(
			parent,
			localFunction,
			/* enableProperties: */ localFunction.functionJsonPath !== undefined
		);
	}
	...
	public static async create(
		...
		parent: LocalFunctionsTreeItem,
		localFunction: ILocalFunction
	): Promise<LocalFunctionTreeItem> {
		const ti: LocalFunctionTreeItem = new LocalFunctionTreeItem(
			parent,
			localFunction
		);

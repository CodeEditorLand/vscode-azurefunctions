...
import {
	RemoteFunctionTreeItem,
	getFunctionNameFromId,
} from "./RemoteFunctionTreeItem";
...
export class RemoteFunctionsTreeItem extends FunctionsTreeItemBase {
	...
	public static async createFunctionsTreeItem(
		context: IActionContext,
		parent: SlotTreeItem,
	): Promise<RemoteFunctionsTreeItem> {
        ...
        */
		...
		return await this.createTreeItemsWithErrorHandling(
			...
			async (fe: FunctionEnvelope) =>
				await RemoteFunctionTreeItem.create(
					context,
					this,
					new RemoteFunction(
						this.parent,

...
export class ResolvedContainerizedFunctionAppResource
	...
	implements ResolvedAppResourceBase
{
	...
	public static containerContextValue = "azFuncContainer";
	...
	public constructor(subscription: ISubscriptionContext, site: Site) {
		super(
			Object.assign(site, {
				defaultHostUrl: `https://${site.defaultHostName}`,
				fullName: site.name,
				isSlot: false,
			}),
		);
		...
		const valuesToMask = [
			...
			this.site.repositorySiteName,
			...(this.site.hostNames || []),
			...(this.site.enabledHostNames || []),
		];
	...
	public static async createResolvedFunctionAppResource(
		context: IActionContext,
		subscription: ISubscriptionContext,
		site: Site,
	): Promise<ResolvedContainerizedFunctionAppResource> {
		const resource = new ResolvedContainerizedFunctionAppResource(
			subscription,
			site,
		);
	...
	public async loadMoreChildrenImpl(
		...
		this._functionsTreeItem = new ContainerFunctionsTreeItem(
			proxyTree,
			this.site,
		);
	...
	public async deleteTreeItemImpl(context: IActionContext): Promise<void> {
		const wizardContext: DeleteFunctionappWizardContext = Object.assign(
			context,
			{
				site: this.site,
				...this._subscription,
		...
		for (const expectedContextValue of expectedContextValues) {
			...
			if (
				matchContextValue(expectedContextValue, [
					ResolvedContainerizedFunctionAppResource.containerContextValue,
				])
			) {

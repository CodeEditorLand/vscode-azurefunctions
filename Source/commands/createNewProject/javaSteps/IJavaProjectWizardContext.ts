...
export function getJavaPackagePath(
	projectPath: string,
	packageName: string,
): string {
	return path.join(
...
export function getJavaFunctionFilePath(
	projectPath: string,
	packageName: string,
	functionName: string,
): string {
	return path.join(
		getJavaPackagePath(projectPath, packageName),
		getJavaClassName(functionName) + ".java",
	);
}

	...
	public async executeCore(
		...
		try {
			...
			await mavenUtils.executeMvnCommand(
				...
				mavenUtils.formatMavenArg(
					"DgroupId",
					nonNullProp(context, "javaGroupId"),
				),
				mavenUtils.formatMavenArg("DartifactId", artifactId),
				mavenUtils.formatMavenArg(
					"Dversion",
					nonNullProp(context, "javaProjectVersion"),
				),
				mavenUtils.formatMavenArg(
					"Dpackage",
					nonNullProp(context, "javaPackageName"),
				),
				mavenUtils.formatMavenArg(
					"DappName",
					nonNullProp(context, "javaAppName"),
				),
				"-B", // in Batch Mode
			);

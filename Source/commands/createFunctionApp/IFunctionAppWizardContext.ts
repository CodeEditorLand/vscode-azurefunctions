...
} from "./stacks/models/FunctionAppStackModel";
...
export interface IFunctionAppWizardContext
	extends IAppServiceWizardContext,
...
export interface IFunctionAppAgentWizardContext
	extends IFunctionAppWizardContext {
	ui: IAzureAgentInput;
}

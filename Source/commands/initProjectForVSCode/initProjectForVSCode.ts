...
import { type FuncVersion, latestGAVersion } from "../../FuncVersion";
import {
...
import {
	...
	detectProjectLanguageModel,
} from "./detectProjectLanguage";
...
export async function initProjectForVSCode(
	...
	void window.showInformationMessage(
		localize(
			...
			"Finished initializing for use with VS Code.",
		),
	);
}

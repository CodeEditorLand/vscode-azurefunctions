...
export class EventHubsNamespaceAuthRuleCreateStep<
	...
	public async execute(
		...
		const defaultParams: AuthorizationRule = {
			rights: [
				...
				KnownAccessRights.Send,
				KnownAccessRights.Listen,
			],
		};
		...
		context.authRule =
			await client.namespaces.createOrUpdateAuthorizationRule(
				rgName,
				namespaceName,
				authRuleName,
				defaultParams,

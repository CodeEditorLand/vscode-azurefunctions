...
import {
	getJavaFunctionFilePath,
	type IJavaProjectWizardContext,
} from "../../createNewProject/javaSteps/IJavaProjectWizardContext";
import { FunctionCreateStepBase } from "../FunctionCreateStepBase";
import {
	getBindingSetting,
	type IFunctionWizardContext,
} from "../IFunctionWizardContext";
import {
	type IJavaFunctionTemplate,
	type IJavaFunctionWizardContext,
} from "./IJavaFunctionWizardContext";

export class JavaFunctionCreateStep extends FunctionCreateStepBase<
	IFunctionWizardContext & IJavaProjectWizardContext
> {
	public async executeCore(
		context: IJavaFunctionWizardContext & IJavaProjectWizardContext,
	): Promise<string> {
		const template: IJavaFunctionTemplate = nonNullProp(
			context,
			"functionTemplate",
		);
...
function substituteParametersInTemplate(
	template: IJavaFunctionTemplate,

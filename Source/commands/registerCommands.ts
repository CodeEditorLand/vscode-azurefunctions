...
import {
	getAgentBenchmarkConfigs,
	getCommands,
	runWizardCommandWithInputs,
	runWizardCommandWithoutExecution,
} from "../agent/agentIntegration";
...
} from "./createNewProject/createNewProject";
...
import {
	...
	deployProductionSlotByFunctionAppId,
	deploySlot,
} from "./deploy/deploy";
...
export function registerCommands(): void {
	...
	commands.registerCommand(
		"azureFunctions.agent.getAgentBenchmarkConfigs",
		getAgentBenchmarkConfigs,
	);
	...
	ext.context.subscriptions.push(
		languages.registerCodeLensProvider(
			{ pattern: "**/*.eventgrid.json" },
			ext.eventGridProvider,
		),
	);

	registerCommand(
		"azureFunctions.eventGrid.sendMockRequest",
		sendEventGridRequest,
	);
}

...
import {
	ConnectionType,
	type EventHubsConnectionTypeValues,
	type SqlDbConnectionTypeValues,
} from "../../../../constants";
...
export class AzureWebJobsStoragePromptStep<
...
> extends AzureWizardPromptStep<T> {
	...
	public async prompt(context: T): Promise<void> {
		...
		context.telemetry.properties.azureWebJobsStorageType =
			context.azureWebJobsStorageType;
	}

...
import {
	type IDeployContext,
	type ParsedSite,
	showCustomDeployConfirmation,
} from "@microsoft/vscode-azext-azureappservice";
import type { MessageItem } from "vscode";
import { localize } from "../../localize";

export async function showFlexDeployConfirmation(
	...
	const remoteDeploy: MessageItem = {
		title: localize("remoteDeploy", "Deploy with Remote Build "),
	};
	const input: MessageItem = await showCustomDeployConfirmation(
		context,
		site,
		deployCommandId,
		{ items: [remoteDeploy] },
